...
export async function generateMetadata({
  ...
  return constructMetadata({
    page: "Guides",
    title: "Minute Cryptic Guides - Solving Techniques and Patterns",
    description:
      "Comprehensive guides for minute cryptic clues. From beginner basics to advanced techniques, learn practical solving patterns and clue mechanics.",
    keywords: [
      "minute cryptic guides",
      "cryptic clue strategy guide",
      "how to solve minute cryptic",
      "cryptic clue tips",
      "minute cryptic tutorial",
      "dailycryptic guides",
    ],
      ...
      <header className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/5 via-white to-primary/5 p-6 sm:p-8 dark:border-primary/40 dark:from-zinc-900 dark:via-zinc-900 dark:to-primary/10">
        ...
        <div className="relative">
          ...
          <p className="mt-2 max-w-2xl text-muted-foreground">
            From beginner basics to advanced expert techniques. Master minute
            cryptic solving with our guide collection.
          </p>
        </div>
      </header>
